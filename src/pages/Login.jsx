  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 via-white to-violet-50">
      <div className="slide-up">
        <div className="bg-white rounded-3xl shadow-xl shadow-indigo-200/20 border border-indigo-100/30 p-10 w-full max-w-sm relative overflow-hidden">
          ...
          <div className="text-center mb-8 relative">
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-indigo-500 to-violet-600 flex items-center justify-center text-3xl mx-auto mb-4 shadow-lg shadow-indigo-200/50">
