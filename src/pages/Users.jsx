        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="bg-indigo-50/50 text-gray-500 text-xs uppercase tracking-wider">
              ...
              <th className="px-5 py-3.5 text-left font-semibold">Total Rides</th>
                  ...
                  <tr key={user.id} className="hover:bg-indigo-50/30 transition-colors slide-in-right" style={{ animationDelay: `${i * 20}ms` }}>
                    <td className="px-5 py-3.5">
                      <div className="flex items-center gap-3">
                        {user.photoUrl ? (
                          <img src={user.photoUrl} className="w-9 h-9 rounded-full object-cover ring-2 ring-indigo-100" alt="" />
                        ) : (
                          <div className={`w-9 h-9 rounded-full bg-gradient-to-br ${avatarColor} flex items-center justify-center text-xs font-bold ring-2 ring-indigo-100`}>
                    ...
                    <td className="px-5 py-3.5 text-gray-500 text-xs">{user.email || <span className="text-gray-300 italic">—</span>}</td>
                    <td className="px-5 py-3.5 text-gray-500 font-mono text-xs">{user.phone || '—'}</td>
                    <td className="px-5 py-3.5">
                    ...
                    <td className="px-5 py-3.5 font-medium text-gray-700">{user.totalRides ?? 0}</td>
